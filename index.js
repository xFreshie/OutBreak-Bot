...
var wot = [
  ...
  const embed = new Discord.MessageEmbed()
    ...
    .addField("Joined At", `${member.joinedAt.format("dddd, MMMM Do YYYY, HH:mm:ss")}`, true)
    .addField("Created At", `${member.user.createdAt.format("dddd, MMMM Do YYYY, HH:mm:ss")}`, true);
