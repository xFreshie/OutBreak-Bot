...
const options = {
  ...
  try {
    ...
    return message.channel.send(`We have a winner! *${winnerMessage.author.username}* had a right answer with \`${winnerMessage.content}\`!`);
  } catch (_) {
    return message.channel.send("Seems no one got it! Oh well.");
  }
  }
});
