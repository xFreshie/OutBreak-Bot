...
if(command === "blacklist") {
    ...
    blacklist = JSON.parse(blacklistJson);
        ...
        while (i < blacklist.length && !found) {
            if (blacklist[i] === id) {
                found = true;
                message.reply("they're already blacklisted you idiot!");
            }
            i++;
        }
        if (!found) {
